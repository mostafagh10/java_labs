...
public class Main {
    public static void main(String[] args) {
        ...
        Dictinary D = new Dictinary(map1);
        for(int i=0 ; i<26 ; i++) {
        ...
        while(i==0){
            ...
            if(numofchoice == 1){
                ...
                D.addStringToMapList(map1, thekey, thestringsarray);
                ...
                D.removeStringFromMapList(map1,thekey,thestring);
                ...
                String thestring = myObj3.nextLine();
                boolean search = D.stringExistsInMapList(map1,thekey,thestring);
                if(search == true){
